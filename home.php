...
<html lang="pt-br">
  ...
  <body>
    ...
    <nav class="navbar navbar-default">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="barra-navegacao">
          ...
          <div class="nav navbar-nav navbar-right naveg-dentro">
              ...
              <a href="<?php echo 'home.php?nick=';echo $_SESSION['logado']; ?>">
              <button id="inicial" type="button" class="btn btn-primary btnNaveg">Pagina Inicial</button>
              </a>
   	...
   	<div class="container">
        ...
        <div style="width: 500px;" class="row">
            ...
            <h4 style="text-align: center;"><?= $_SESSION['feedatual'] ?></h4>
      ...
      <!-- Conteúdo das abas -->
      <div style="left: 100px;" class="tab-content">
