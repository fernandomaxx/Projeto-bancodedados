    ...
    <nav class="navbar navbar-default">
      <div class="container">
   	...
   	<div class="container">
   		...
   		<div class="col-md-4">
        <div class="row">
            <div class="well  wellPerfil">
            <img id="imgPerfilPrinc" src="img/ciufpb.png" class="img-thumbnail">
            <h4 style="text-align: center;">Nome Perfil</h4>
            <!--
            <button style="margin-top: 46px;"type="button" class="btn-primary form-control" >Grupos </button>
            -->
            </div>
        </div>
      </div>
      ...
      <ul class="nav nav-tabs abasperfil" role="tablist">
        ...
        <li><a href="#avaliacoes" role="tab" data-toggle="tab">Amigos</a></li>
      ...
      <div class="tab-content">
        ...
        <div class="row parteMeioPerfil">
          
          <div class="postPerfil well">
          ...
          <ul class="list-group listafeedPerfil">
